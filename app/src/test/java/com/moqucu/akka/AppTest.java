...
import com.moqucu.akka.actor.MyActor;
import com.moqucu.akka.actor.ReadingActor;
import com.moqucu.akka.actor.WordCounterActor;
...
class AppTest {
    ...
    public void givenAnActor_sendHimAMessageUsingTell() {
        ...
        myActorRef.tell("printit", probe.getTestActor());
    ...
    public void givenAnActor_sendHimAMessageUsingAsk() throws ExecutionException, InterruptedException {
        ...
        CompletableFuture<Object> future = toJava(Patterns.ask(
                wordCounterActorRef,
                new WordCounterActor.CountWords("this is a text"),
                1000
        )).toCompletableFuture();
    ...
    public void givenAnActor_whenTheMessageIsNull_respondWithException() {
        ...
        CompletableFuture<Object> future = toJava(Patterns.ask(
                wordCounterActorRef,
                new WordCounterActor.CountWords(null),
                1000
        )).toCompletableFuture();
